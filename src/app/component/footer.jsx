...
export function FooterWithSocialLinks() {
  return (
    <footer className="relative w-full bg-gray-900 mt-8">
      <div className="mx-auto w-full max-w-7xl px-8">
                ...
                {items.map((link) => (
                  <li key={link}>
                    <Typography
                      ...
                      href="#"
                      color="gray"
                      className="py-1.5 font-normal text-white transition-colors hover:text-blue-gray-400"
                    >
                      {link}
                    </Typography>
                  </li>
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="#">M Dafa Azharya</a>. All
            Rights Reserved.
          </Typography>
